...
export const useJobMatchesStore = create<JobMatchStore>((set, get) => ({
  ...
  reset: () => set({ jobMatches: undefined, loading: false, error: undefined }), // only exist for used within testing
}));

export const useJobActionStore = create<JobActionStore>((set) => ({
  success: true,
  message: undefined,
  errorCode: undefined,
  // real life will not have default worker id
  ...
  reset: () => set({ success: true, message: undefined, errorCode: undefined }), // only exist for used within testing
}));
...
export const useProfileStore = create<ProfileStore>((set) => ({
  ...
  reset: () => set({ profile: undefined, loading: false, error: undefined }), // only exist for used within testing
}));
